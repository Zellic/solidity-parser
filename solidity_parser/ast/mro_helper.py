from solidity_parser.ast.symtab import ContractInterfaceLibraryScope
...
def c3_linearise(klass: ContractInterfaceLibraryScope) -> List[ContractInterfaceLibraryScope]:
