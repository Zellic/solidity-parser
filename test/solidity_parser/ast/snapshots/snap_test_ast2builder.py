...
snapshots['TestSolidityTypeHelper::test_get_expr_type 1'] = [
    ...
    "BinaryOp(left=GetMember(obj_base=Ident(text='msg'), name=Ident(text='sender')), right=Ident(text='addressValue'), op=<BinaryOpCode.EQ: '=='>) :: bool",
    "GetMember(obj_base=Ident(text='msg'), name=Ident(text='sender')) :: [AddressType(is_payable=False)]",
    "CallFunction(callee=Ident(text='CustomError'), modifiers=[], args=[Literal(value='This is a custom error', unit=None)]) :: NodeList()",
    ...
    "GetMember(obj_base=Ident(text='msg'), name=Ident(text='sender')) :: [AddressType(is_payable=False)]",
    "BinaryOp(left=Ident(text='bytesValue'), right=CallFunction(callee=BytesType(base_type=ByteType()), modifiers=[], args=[Literal(value='Hello, Solidity!', unit=None)]), op=<BinaryOpCode.ASSIGN: '='>) :: bytes",
    ...
    "BinaryOp(left=Ident(text='fixedArray'), right=NewInlineArray(elements=[CallFunction(callee=IntType(is_signed=False, size=256), modifiers=[], args=[Literal(value=1, unit=None)]), Literal(value=2, unit=None), Literal(value=3, unit=None)]), op=<BinaryOpCode.ASSIGN: '='>) :: uint256[3]",
    'NewInlineArray(elements=[CallFunction(callee=IntType(is_signed=False, size=256), modifiers=[], args=[Literal(value=1, unit=None)]), Literal(value=2, unit=None), Literal(value=3, unit=None)]) :: uint256[3]',
    'CallFunction(callee=IntType(is_signed=False, size=256), modifiers=[], args=[Literal(value=1, unit=None)]) :: uint256',
    'Literal(value=1, unit=None) :: uint8(1)',
    'Literal(value=2, unit=None) :: uint8(2)',
    'Literal(value=3, unit=None) :: uint8(2)',
    "CallFunction(callee=GetMember(obj_base=Ident(text='dynamicArray'), name=Ident(text='push')), modifiers=[], args=[Literal(value=4, unit=None)]) :: NodeList()",
    "GetMember(obj_base=Ident(text='dynamicArray'), name=Ident(text='push')) :: [FunctionType(inputs=NodeList(), outputs=NodeList()), FunctionType(inputs=NodeList(), outputs=NodeList())]",
    'Literal(value=4, unit=None) :: uint8(3)',
    "CallFunction(callee=GetMember(obj_base=Ident(text='dynamicArray'), name=Ident(text='push')), modifiers=[], args=[Literal(value=5, unit=None)]) :: NodeList()",
    "GetMember(obj_base=Ident(text='dynamicArray'), name=Ident(text='push')) :: [FunctionType(inputs=NodeList(), outputs=NodeList()), FunctionType(inputs=NodeList(), outputs=NodeList())]",
    'Literal(value=5, unit=None) :: uint8(3)',
    "BinaryOp(left=Ident(text='myStructValue'), right=CallFunction(callee=Ident(text='MyStruct'), modifiers=[], args=[Literal(value=10, unit=None), Literal(value='Example', unit=None)]), op=<BinaryOpCode.ASSIGN: '='>) :: ResolvedUserType(MyStruct)",
    ...
    "CallFunction(callee=Ident(text='MyEvent'), modifiers=[], args=[GetMember(obj_base=Ident(text='msg'), name=Ident(text='sender')), Literal(value=100, unit=None)]) :: NodeList()",
    "GetMember(obj_base=Ident(text='msg'), name=Ident(text='sender')) :: [AddressType(is_payable=False)]",
    ...
    'Literal(value=10, unit=None) :: uint8(4)',
    'Literal(value=5, unit=None) :: uint8(3)',
    "BinaryOp(left=Ident(text='integerValue'), right=CallFunction(callee=IntType(is_signed=True, size=256), modifiers=[], args=[Ident(text='newValue')]), op=<BinaryOpCode.ASSIGN: '='>) :: int256",
    "CallFunction(callee=IntType(is_signed=True, size=256), modifiers=[], args=[Ident(text='newValue')]) :: int256",
    "BinaryOp(left=Ident(text='integerValue'), right=CallFunction(callee=IntType(is_signed=True, size=256), modifiers=[], args=[Ident(text='newValue')]), op=<BinaryOpCode.ASSIGN: '='>) :: int256",
    "CallFunction(callee=IntType(is_signed=True, size=256), modifiers=[], args=[Ident(text='newValue')]) :: int256",
    'Literal(value=1, unit=None) :: uint8(1)',
    ...
    "GetMember(obj_base=CreateMetaType(base_type=UserType(name=Ident(text='AllTypesExample'))), name=Ident(text='name')) :: [StringType(base_type=FixedLengthArrayType(base_type=ByteType(), size=1))]",
    "CreateMetaType(base_type=UserType(name=Ident(text='AllTypesExample'))) :: MetaTypeType(ttype=ResolvedUserType(AllTypesExample))",
    "Literal(value=(GetMember(obj_base=CreateMetaType(base_type=IntType(is_signed=True, size=16)), name=Ident(text='min')), GetMember(obj_base=CreateMetaType(base_type=IntType(is_signed=True, size=16)), name=Ident(text='max'))), unit=None) :: TupleType(ttypes=NodeList())",
...
snapshots['TestSolidityTypeHelper::test_get_function_expr_type 1'] = [
    "CallFunction(callee=Ident(text='MyError'), modifiers=[], args=[Literal(value='This is a custom error', unit=None)]) :: NodeList()",
    "CallFunction(callee=IntType(is_signed=True, size=256), modifiers=[], args=[Ident(text='newValue')]) :: int256",
    "CallFunction(callee=Ident(text='functionWithInputs'), modifiers=[], args=[Literal(value=5, unit=None), Literal(value='hi', unit=None)]) :: NodeList()",
    "CallFunction(callee=Ident(text='functionWithoutInputs'), modifiers=[], args=[]) :: NodeList()",
    "CallFunction(callee=Ident(text='voidFunction'), modifiers=[], args=[Ident(text='k')]) :: NodeList()"
]
...
snapshots['TestSolidityTypeHelper::test_get_function_expr_type_inline_arrays 1'] = [
    ...
    "NewInlineArray(elements=[CallFunction(callee=IntType(is_signed=True, size=256), modifiers=[], args=[Literal(value=1, unit=None)]), CallFunction(callee=IntType(is_signed=True, size=256), modifiers=[], args=[UnaryOp(expr=Literal(value=1, unit=None), op=<UnaryOpCode.SIGN_NEG: '-'>, is_pre=True)]), CallFunction(callee=IntType(is_signed=True, size=256), modifiers=[], args=[Literal(value=0, unit=None)]), CallFunction(callee=IntType(is_signed=True, size=256), modifiers=[], args=[Literal(value=0, unit=None)]), CallFunction(callee=IntType(is_signed=True, size=256), modifiers=[], args=[Literal(value=0, unit=None)])]) :: int256[5]",
    'NewInlineArray(elements=[CallFunction(callee=IntType(is_signed=True, size=8), modifiers=[], args=[Literal(value=0, unit=None)]), CallFunction(callee=IntType(is_signed=True, size=8), modifiers=[], args=[Literal(value=0, unit=None)]), CallFunction(callee=IntType(is_signed=True, size=8), modifiers=[], args=[Literal(value=0, unit=None)]), CallFunction(callee=IntType(is_signed=True, size=8), modifiers=[], args=[Literal(value=0, unit=None)]), CallFunction(callee=IntType(is_signed=True, size=8), modifiers=[], args=[Literal(value=0, unit=None)])]) :: int8[5]',
