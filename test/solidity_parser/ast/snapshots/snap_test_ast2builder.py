...
snapshots['TestSolidityTypeHelper::test_get_expr_type 1'] = [
    ...
    "BinaryOp(left=GetMember(obj_base=Ident(text='msg'), name=Ident(text='sender')), right=Ident(text='addressValue'), op=<BinaryOpCode.EQ: '=='>) :: bool",
    "GetMember(obj_base=Ident(text='msg'), name=Ident(text='sender')) :: [AddressType(is_payable=False)]",
    "CallFunction(callee=Ident(text='CustomError'), modifiers=[], args=[Literal(value='This is a custom error', unit=None)]) :: []",
    ...
    "GetMember(obj_base=Ident(text='msg'), name=Ident(text='sender')) :: [AddressType(is_payable=False)]",
    "BinaryOp(left=Ident(text='bytesValue'), right=CallFunction(callee=BytesType(base_type=FixedLengthArrayType(base_type=ByteType(), size=1)), modifiers=[], args=[Literal(value='Hello, Solidity!', unit=None)]), op=<BinaryOpCode.ASSIGN: '='>) :: bytes",
    ...
    "CallFunction(callee=Ident(text='MyEvent'), modifiers=[], args=[GetMember(obj_base=Ident(text='msg'), name=Ident(text='sender')), Literal(value=100, unit=None)]) :: []",
    "GetMember(obj_base=Ident(text='msg'), name=Ident(text='sender')) :: [AddressType(is_payable=False)]",
...
snapshots['TestSolidityTypeHelper::test_get_function_expr_type 1'] = [
    "CallFunction(callee=Ident(text='MyError'), modifiers=[], args=[Literal(value='This is a custom error', unit=None)]) :: []",
    "CallFunction(callee=IntType(is_signed=True, size=256), modifiers=[], args=[Ident(text='newValue')]) :: int256",
    "CallFunction(callee=Ident(text='functionWithInputs'), modifiers=[], args=[Literal(value=5, unit=None), Literal(value='hi', unit=None)]) :: [IntType(is_signed=False, size=256)]",
    "CallFunction(callee=Ident(text='functionWithoutInputs'), modifiers=[], args=[]) :: [IntType(is_signed=False, size=256)]",
    "CallFunction(callee=Ident(text='voidFunction'), modifiers=[], args=[Ident(text='k')]) :: []"
]
